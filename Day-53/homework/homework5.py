...
# ასევე რამდენი ხნით სურს დროში მოგზაურობა შემდეგ კი ფუნქციამ უნდა დაბეჭდოს დროში მოგზაურობის შემდეგ რომელი წელი იქნება 
...
def time_travel():
    ...
    print("After the time travel it will be year", future_year, "and you will be", future_age, "years old")
